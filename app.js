...
// ✅ connect-mongo v6 me default export use karna padta hai
...
// ─── Session — MongoDB me store (Render restart safe) ──
app.use(session({
  secret: process.env.SESSION_SECRET,
  resave: false,
  saveUninitialized: false,
  // ✅ MongoDB me sessions store — memory wali session Render pe clear hoti thi
